$.fn.attachKeyboard = function(options) {
    ...
    return this.each(function() {
        ...
        $(trigger).click(function() {
            $(keyboard).css({
                'top': this.offsetTop  + opts.topOffset,
                'left': this.offsetLeft +  opts.leftOffset				
            });
